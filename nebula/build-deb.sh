...
#echo $(DEBIAN_ARCH amd64)
#echo $(DEBIAN_ARCH arm64)
#exit

PKG_NAME=nebula
FULL_PKG_NAME=${PKG_NAME}_${VERSION}-${DEBVERSION}_$(DEBIAN_ARCH $ARCH)
PKG_DIR=$FULL_PKG_NAME
...
_BINPKG_SHA256="f1a82c27624bf319c35f3bb4c136d5b82f26b014e8f5d16f64b3b0089f60220c
40f926a8c86e2776259db5edf795b904dc8269c33b0d433f1c01e817d8368cd8"

AUX_FILES="AUTHORS CHANGELOG.md LICENSE README.md"
AUX_FILES_SHA256=""




BINPKG_FILE=$GITHUB_PRJ-$GITHUB_OS-$(GITHUB_ARCH $ARCH).$BINPKG_EXT
...
sed -i "${BASEDIR}/${PKG_DIR}/control/control" -e "s,@VERSION@,${VERSION}-${DEBVERSION}," -e "s,@ARCH@,$(DEBIAN_ARCH $ARCH),"
